  ...
  return (
    <section className="flex items-center justify-center px-6 pt-28 pb-16">
      ...
      >
        ...
        >
          Product designer with 10+ years. Designing products used by millions across travel, fintech, and edtech. Led design at ixigo, Fincent, and Unacademy. Currently building with Claude Code.
        </motion.p>
